    ...
    <article className="flex items-center py-4 border-b border-gray-200 justify-between w-full">
      <div>
        ...
        <div className="text-lg text-gray-600 mb-4 text-ellipsis">
          {excerpt.slice(0, 500)}
        <div className="text-lg text-gray-600 mb-4 text-ellipsis italic">
          {excerpt.slice(0, 250)}...
        </div>
      ...
      <Link as={`/${slug}`} href="/[...slug]" className="block shrink-0 ml-6">
        ...
        <svg className="w-4 h-4 fill-current text-[#001165]" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
