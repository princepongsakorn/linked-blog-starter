      ...
      <div ref={containerRef} className="max-w-4xl mx-auto flex flex-wrap mt-5 px-5">
        ...
        <div className="w-full">
          ...
          <div className="relative flex items-center">
            <input ref={inputRef} id="search" type="search" className="form-input w-full text-gray-800 px-3 py-2 pl-10 outline-[#03003c]" placeholder="Search my notes" onChange={handleChangeInput}/>
